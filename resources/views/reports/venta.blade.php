                                        ...
                                        <table width="100%" height="0" border="0" border-radius="" cellpadding="9" cellspacing="0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <strong>Cliente: </strong>{{$venta->cliente->razon_social}}
                                                    </td>
                                                </tr>
                            ...
                            <table width="100%" border="0" cellpadding="5" cellspacing="0">
                                <tbody>
                                    <tr>
                                        ...
                                        <td align="center " colspan="5" class="bold">DETALLE DE VENTA</td>
                                    </tr>
                                    <tr class="border_top">
                                        ...
                                        <tr class="border_top">
                                            ...
                                            <td align="left">
                                                {{$d->inventario->articulo->medida->nombre}}
                                            </td>
                                            <td align="left">
                            ...
                            <table width="100%" border="0" cellpadding="5" cellspacing="0">
                                <tbody>
                                    ...
                                    <tr class="border_top">
                                        ...
                                        <td align="left" class="bold">Recibido: {{number_format($venta->pago, 0, ',', '.')}} </td>
                                        <td align="left" class="bold">Cambio: {{number_format($venta->cambio, 0, ',', '.')}}</td>
