                                    ...
                                    <div class="tabla_borde">
                                        <table width="100%" border="0" height="50" cellpadding="2" cellspacing="0">
                                            <tbody>
                                                <tr>
                                                    <td align="center">
                                                        <span style="font-family:Tahoma, Geneva, sans-serif; font-size:19px" text-align="center">PEDIDO </span>
                                                    </td>
                                                </tr>

                                                <tr>
                                                    <td align="center">
                                                        <span style="font-size:19px">N° {{$pedido->id}} </span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center">
                                                        <span style="font-size:14px">Fecha de registro: {{$pedido->fecha}} </span>
                                                    </td>
                                                </tr>
                                        ...
                                        <table width="100%" height="0" border="0" border-radius="" cellpadding="9" cellspacing="0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <strong>Cliente: </strong>{{$pedido->cliente->razon_social}}
                                                    </td>
                                                </tr>
                            ...
                            <table width="100%" border="0" cellpadding="5" cellspacing="0">
                                <tbody>
                                    <tr>
                                        ...
                                        <td align="center " colspan="5" class="bold">DETALLE DE PEDIDO</td>
                                    </tr>
                                    <tr class="border_top">
                                        <td align="left" class="bold">CANTIDAD</td>
                                        <td align="left" class="bold">U. MEDIDA</td>
                                        ...
                                        <?php
                                        $n = 1;
                                        foreach($pedido->pedido_detalles as $d){
                                                                           ?>
                                        <tr class="border_top">
                                            <td align="left">
                                            ...
                                            <td align="left">
                                                {{$d->articulo->medida->nombre}}
                                            </td>
                                            <td align="left">
                                                {{$d->articulo->nombre}}
                                            </td>
                                            <td align="left">
                                            {{number_format($d->neto, 0, ',', '.')}}
                                            </td>
                                            <td align="left">
                                            {{number_format($d->neto*$d->cantidad, 0, ',', '.')}}
                                            </td>
